...
from .prompts.system import MINT_DIRECTOR_INSTRUCTION
...
root_agent = Agent(
    ...
    name="product_photo_director",
    description="AI Product Photography Director that turns product briefs into studio-quality photo sets",
    instruction=MINT_DIRECTOR_INSTRUCTION,
